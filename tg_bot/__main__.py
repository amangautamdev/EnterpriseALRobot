...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/opamanxworld'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/opamanxworld',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/AMAN_WORLD",
                            ),
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [InlineKeyboardButton(text="Back", callback_data="help_back"),
                     InlineKeyboardButton(text='Support', url='https://t.me/opamanxworld')]
                )
                send_help(
                    chat.id,
                    text,
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"Shizuka started, Using webhooks. | BOT: [@{dispatcher.bot.username}]")

    else:
        log.info(f"Shizuka started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
        ShizukaINIT.bot_id = dispatcher.bot.id
        ShizukaINIT.bot_username = dispatcher.bot.username
        ShizukaINIT.bot_name = dispatcher.bot.first_name
...
if __name__ == "__main__":
    log.info("[SHIZUKA] Successfully loaded modules: " + str(ALL_MODULES))
