...
logging.basicConfig(
    ...
    handlers=[RotatingFileHandler('Shizuka.log', maxBytes=1024*1024, backupCount=5), logging.StreamHandler()],
    level=logging.INFO,
)
...
log.info("[SHIZUKA] Shizuka is starting. | An Eagle Union Project. | Licensed under GPLv3.")
log.info("[SHIZUKA] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[SHIZUKA] Project maintained by: github.com/Dank-del (t.me/dank_as_fuck)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[SHIZUKA] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)
...
class ShizukaINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "Shizuka" #placeholder
        self.bot_username = "ShizukaaRobot" #placeholder
...
KInit = ShizukaINIT(parser=kigconfig)
