...
def get_user_info(chat: Chat, user: User) -> str:
    ...
    if user.id == OWNER_ID:
        ...
        text += '\nThis Person is a part of Legend Union'
        Nation_level_present = True
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://graph.org/file/6488feb16d7426de01959.jpg) | [⍚ GitLab](https://gitlab.com/Aman/EnterpriseALRobot)\n\n" +
            "╘══「 by [Aman](github.com/) 」\n",
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + "\n\n⍙ [GitHub](https://graph.org/file/6488feb16d7426de01959.jpg) | ⍚ [GitLab](https://graph.org/file/6488feb16d7426de01959.jpg)\n\n"
                )
                + "╘══「 by [Aman](github.com/) 」\n"
            ),
