...
kigcmd = ShizukaTelegramHandler(d).command
kigmsg = ShizukaTelegramHandler(d).message
kigcallback = ShizukaTelegramHandler(d).callbackquery
kiginline = ShizukaTelegramHandler(d).inlinequery
