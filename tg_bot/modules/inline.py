...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            #},
            {
                "title": "Account info on Shizuka",
                "description": "Look up a Telegram account in Shizuka database",
                "message_text": "Click the button below to look up a person in Shizuka database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about Shizuka",
                "message_text": "Click the button below to get to know about Shizuka.",
                "thumb_urL": "https://graph.org/file/6488feb16d7426de01959.jpg",
                "keyboard": ".about ",
            },
            {
                "title": "Anilist",
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Report Error", url="https://t.me/opamanxworld"), InlineKeyboardButton(text="Search again", switch_inline_query_current_chat=".info ",)]])
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Shizuka (@{context.bot.username})",
...
def media_query(query: str, update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Report error", url="t.me/opamanxworld"), InlineKeyboardButton(text="Search again", switch_inline_query_current_chat=".anilist ")]])
